#!/usr/bin/env python3
'''
unwind velocity positive [dps] and tether linear velocity positive [mm/s]
wind velocity negative [dps] and tether linear velocity negative [mm/s]
'''
...
class PIDController:
    ...
    def spool_vel_callback(self, msg):
        self.spool_vel = msg.data/1000 #[mm/s]->[m/s]
